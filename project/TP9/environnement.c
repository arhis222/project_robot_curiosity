...
resultat_deplacement avancer_envt(Environnement *envt) {
  ...
  envt->etat_obs=transition_2(envt->etat_obs,A);
...
void gauche_envt(Environnement *envt) {
  ...
  envt->etat_obs=transition_2(envt->etat_obs,G);
...
void droite_envt(Environnement *envt) { 
  ...
  envt->etat_obs=transition_2(envt->etat_obs,D);
...
int resultat_observateur(Environnement *envt){
  ...
  return est_final_2(envt->etat_obs);
